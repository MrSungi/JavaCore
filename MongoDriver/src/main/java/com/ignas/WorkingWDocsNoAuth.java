...
public class WorkingWDocsNoAuth {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Document document = new Document()
                .append("name", "Ignas")
                .append("middle_name", "Ignas")
                .append("surname", "Sungaila");
        ...
        //    }
        // )
        BasicDBObject searchQuery = (new BasicDBObject()).append("name"  , "Ignas").append("middle_name", "Jonassc");
        coll.updateOne(searchQuery, new Document("$set", new Document("surname", "DDD")));
